...
if __name__ == '__main__':
    ...
    # Train test split --------------------
    dataset_1_x_train, dataset_1_x_validation, dataset_1_y_train, dataset_1_y_validation = train_test_split(dataset_1_x, dataset_1_y, test_size=0.3, shuffle=True)
    ...
    my_model = create_simple_ann_pytorch(8, 6, 1, num_layers=3)
    print(my_model)
